...
test('loading the real src/providers tree registers the 5 LLM providers and 5 STT providers', () => {
  loadReal();
  ...
  assert.deepEqual(sttIds, ['faster-whisper', 'assemblyai', 'openai', 'gemini', 'external-ws'], 'STT ids + order');
});
